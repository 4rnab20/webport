...
$$ \log\left(\frac{p_i}{1-p_i}\right) = -10.620170 + 1.146492 \space \text{DiabetesPedigreeFunction} + 0.040539 \space \text{Age} + 0.078362 \space \text{BMI} + 0.042436 \space \text{Glucose}$$ where $p_i$ is the probability of the \$ i\_{\text{th}}\$ individual having diabetes.

Given an individual's diabetes percentage, age, BMI, and glucose level, this model can be used to predictive the probability of diabetes as $$p_{i} = \frac{1}{1+e^{-(-10.620170 + 1.146492 \times \text{DiabetesPedigreeFunction} + 0.040539 \times \text{Age} + 0.078362 \times \text{BMI} + 0.042436 \times \text{Glucose})}}$$
